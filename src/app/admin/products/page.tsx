      ...
      <Card className="p-0 overflow-hidden">
        ...
        <div className="flex items-center justify-end space-x-2 py-4">
            ...
            <div className="space-x-2">
                <Link href={page > 1 ? `/admin/products?page=${page - 1}&search=${search}&sortBy=${sortBy}&sortOrder=${sortOrder}` : '#'}>
                    <Button
                        variant="outline"
                        size="sm"
                        disabled={page <= 1}
                 ...
                 <Link href={page < totalPages ? `/admin/products?page=${page + 1}&search=${search}&sortBy=${sortBy}&sortOrder=${sortOrder}` : '#'}>
                    <Button
                        variant="outline"
                        size="sm"
